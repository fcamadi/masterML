...
No puedo ver bien el resultado poniendo todas las variables juntas, así que elijo algunas de ellas:
...
Quizá pueda ser una posible mejora del modelo.
...
El diagrama de dispersion me parece extrañísimo ...
...
No se reparten a lo largo del eje x de manera aleatoria.
...
Según el test de Shapiro-Wilk los residuos no siguen una distribución normal.
...
El contraste de Breusch-Pagan  devuelve un valor muy inferior a 0, lo que indica la falta de homocedasticidad 
...
En lugar de inventarme 5 registros, he pensado mejor combino de manera aleatoria parejas de registros existentes.
...
*he encontrado críticas sobre este data set.
Si buscas en internet "boston housing dataset criticism", salen unas cuantas ...
(Parece que este dataset también estaba en sckit-learn, y en la versión 1.2 lo quitaron)
