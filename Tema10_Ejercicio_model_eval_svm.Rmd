...
Se puede ver que al tratarse de un dataset descompensado, y ser la clase positiva mucho menos numerosa, se obtiene una precisión terriblemente baja.
...
El valor devuelto por la función Kappa del paquete **vcd** (Visualizing Categorical Data) es muy parecido:
...
Valor muy parecido al valor calculado.
...
confusionMatrix(as.factor(bank_processed_test$y), as.factor(prediction_rbfdot_C3), positive="yes", mode = "everything")
```
