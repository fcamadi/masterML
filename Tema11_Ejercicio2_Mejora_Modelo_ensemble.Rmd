...
Resultado muy parecido a los anteriores (77.78 y 74.75).
...
Con este método se obtiene una exactitud y un valor de Kappa bastante buenos.
...
El resultado no es tan bueno como los dos anteriores.
...
Kappa tiene un valor aceptable.
...
Con adaboost se obtiene el peor resultado con el conjunto de test.


### Random Forests

Utlizaremos directamente caret con las dos librerias (randomForest ranger)
