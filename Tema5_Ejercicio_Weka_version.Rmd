...
install.packages("MultiBoostAB")  # Decision trees RWeka algorithm
...
```{r}
# ## Learn J4.8 tree with reduced error pruning (-R) and minimum number of instances per leaf set to 10 (-M 5)
