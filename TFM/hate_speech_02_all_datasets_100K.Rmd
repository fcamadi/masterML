...
saveRDS(liblinear_svm_model_weights, file="svm_liblinear_all_datasets_28k_freq20_weights_1_2.rds")
...
```{r}
#Save model
saveRDS(liblinear_svm_model_best, file="svm_liblinear_all_datasets_28k_freq20_cost01_bias10_weights_1_2.rds")
```
...
```{r}
#save model
#saveRDS(liblinear_svm_model_weights, file="svm_liblinear_all_datasets_100k_type2_freq50_cost01_bias10_weights_1_2.rds")
