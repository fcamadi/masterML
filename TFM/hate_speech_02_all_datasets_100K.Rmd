...
size <- 78000     # 77432 number of random rows of no hate messages 

# number of min. freq (the lower the size, the lower the freq)
freq <- 50 # now using sparse matrices, let's try :)   
...
Después de las prueba que se han ido haciendo, el resultado no es sorprendente: type 3 y coste 1.
