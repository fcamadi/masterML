...
odio_huggingface_raw <- odio_huggingface_raw[-1]     # -> 574272 obs. of 2 variables
```
...
posts_freq_words_train <- findFreqTerms(posts_dtm_train, 20)  #   100 -> ~17000 terms
                                                          #   500 ->  ~6000
                                                          #  1000 ->  ~3600 
...
La exactitud roza el 82.5%, kappa el 0.52
