...
Como sospechábamos, aquí se da también un caso de sobreajuste a los datos de entrenamiento.
...
sales_model_boost100 <- C5.0(SalesFactor ~ ., data = CarseatsNew_train, trials = 100)
...
Accuracy : 0.7576   10 iteracciones
...
Accuracy : 0.7778   100 iteracciones
