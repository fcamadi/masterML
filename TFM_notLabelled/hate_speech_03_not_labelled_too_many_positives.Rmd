...
svm_liblinear_50k_best <- readRDS("svm_liblinear_all_datasets_50k_freq20_cost01_bias10_weights_1_2.rds")
...
write.table(result1_1000, "subset1_classification_SVM_100k_600k_and_50kbest.csv", sep = "|")
```
