...
```{r}
airquality_raw_completed_with_mean <- airquality_raw |>
            mutate(
...
```{r}
# add date field 
airquality_mean_with_date <- airquality_raw_completed_with_mean
...
```{r}
# add date field 
airquality_median_with_date <- airquality_raw_completed_with_median
...
```{r}
airquality_raw_completed_with_mode <- airquality_raw |>
            mutate(
                  Ozone_MVI = if_else(is.na(Ozone), 1, 0),
...
```{r}
# add date field 
airquality_mode_with_date <- airquality_raw_completed_with_mode
