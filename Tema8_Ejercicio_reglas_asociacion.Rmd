...
inspect(rules_pruned[40:49])
inspect(rules_pruned[50:59])
```
...
Para ver si es más fácil analizarlas, vamos a visualizar las reglas obtenidas con la ayuda de la librería arulesViz:
