...
symptoms <- factor(c("SEVERE", "MILD", "MODERATE"),
                   levels = c("LOW", "MILD", "MODERATE", "SEVERE"),
                   ordered = TRUE)
symptoms
...
mByRow <- matrix(c(1, 2, 3, 4, 5, 6), nrow = 2, byrow=TRUE)
mByRow
...
pt_data <- read.csv("Chapter02/pt_data.csv", stringsAsFactors = TRUE)
pt_data
##### Exploring and understanding data --------------------

## data exploration example using used car data
usedcars <- read.csv("Chapter02/usedcars.csv")
