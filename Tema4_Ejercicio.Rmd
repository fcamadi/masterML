...
Los valores en cada celda son las frecuencias con la que aparece cada palabra en cada documento.
...
Por tanto hay que crear estos conjuntos de manera aleatoria.
...
```
La única diferencia que aprecio entre las dos nubes, es que en la nube negativa se encuentra la palabra "bad" (y "never").
...
Como ya sospechaba, al no haber diferencias tan evidentes entre las nubes de palabras de las críticas positivas y negativas como en las nubes del ejercicio del libro sobre el spam de los mensajes SMS, el resultado no es tan expectacular como en ese otro caso.
